package com.sigbla.prosheet.math
...
operator fun Int.div(that: BigDecimal): Number {
    return this.toBigDecimal(DefaultBigDecimalPrecision.mathContext).divide(that, DefaultBigDecimalPrecision.divRoundingMode)
}
...
operator fun Float.div(that: BigInteger): Number {
    return this.toBigDecimal(DefaultBigDecimalPrecision.mathContext).divide(that.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext), DefaultBigDecimalPrecision.divRoundingMode)
}
...
operator fun BigInteger.div(that: BigDecimal): Number {
    return this.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext).divide(that, DefaultBigDecimalPrecision.divRoundingMode)
}

operator fun BigInteger.div(that: Cell<*>): Number {
    return when (that.value) {
        is Long -> this.divide(that.toBigInteger())
        is Double -> this.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext).divide(that.toBigDecimal(), DefaultBigDecimalPrecision.divRoundingMode)
        is BigInteger -> this.divide(that.toBigInteger())
        is BigDecimal -> this.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext).divide(that.toBigDecimal(), DefaultBigDecimalPrecision.divRoundingMode)
        else -> throw InvalidCellException("Cell not numeric at ${that.index}")
    }
}
...
operator fun BigDecimal.div(that: BigInteger): Number {
    return this.divide(that.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext), DefaultBigDecimalPrecision.divRoundingMode)
}

operator fun BigDecimal.div(that: Cell<*>): Number {
    return when (that.value) {
        is Long -> this.divide(that.toBigDecimal(), DefaultBigDecimalPrecision.divRoundingMode)
        is Double -> this.divide(that.toBigDecimal(), DefaultBigDecimalPrecision.divRoundingMode)
        is BigInteger -> this.divide(that.toBigDecimal(), DefaultBigDecimalPrecision.divRoundingMode)
        is BigDecimal -> this.divide(that.toBigDecimal(), DefaultBigDecimalPrecision.divRoundingMode)
        else -> throw InvalidCellException("Cell not numeric at ${that.index}")
    }
}
...
operator fun Number.plus(that: Float): Number {
    return when (this) {
        ...
        is Float -> this + that
        is Double -> this + that
        is BigInteger -> this.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext).add(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext))
        is BigDecimal -> this.add(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext))
        else -> throw UnsupportedOperationException()
    }
}
...
operator fun Number.minus(that: Float): Number {
    return when (this) {
        ...
        is Float -> this - that
        is Double -> this - that
        is BigInteger -> this.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext).subtract(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext))
        is BigDecimal -> this.subtract(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext))
        else -> throw UnsupportedOperationException()
    }
}
...
operator fun Number.times(that: Float): Number {
    return when (this) {
        ...
        is Float -> this * that
        is Double -> this * that
        is BigInteger -> this.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext).multiply(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext))
        is BigDecimal -> this.multiply(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext))
        else -> throw UnsupportedOperationException()
    }
}
...
operator fun Number.div(that: Int): Number {
    return when (this) {
        ...
        is Double -> this / that
        is BigInteger -> this.divide(that.toBigInteger())
        is BigDecimal -> this.divide(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext), DefaultBigDecimalPrecision.divRoundingMode)
        else -> throw UnsupportedOperationException()
    }
}
...
operator fun Number.div(that: Float): Number {
    return when (this) {
        ...
        is Float -> this / that
        is Double -> this / that
        is BigInteger -> this.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext).divide(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext), DefaultBigDecimalPrecision.divRoundingMode)
        is BigDecimal -> this.divide(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext), DefaultBigDecimalPrecision.divRoundingMode)
        else -> throw UnsupportedOperationException()
    }
}
...
operator fun Number.div(that: BigInteger): Number {
    return when (this) {
        ...
        is BigDecimal -> this.divide(that.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext), DefaultBigDecimalPrecision.divRoundingMode)
        else -> throw UnsupportedOperationException()
    }
}
...
operator fun Number.div(that: BigDecimal): Number {
    return when (this) {
        ...
        is Float -> this / that
        is Double -> this / that
        is BigInteger -> this.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext).divide(that, DefaultBigDecimalPrecision.divRoundingMode)
        is BigDecimal -> this.divide(that, DefaultBigDecimalPrecision.divRoundingMode)
        else -> throw UnsupportedOperationException()
    }
}
...
operator fun Number.rem(that: Float): Number {
    return when (this) {
        ...
        is Float -> this % that
        is Double -> this % that
        is BigInteger -> this.toBigDecimal(mathContext = DefaultBigDecimalPrecision.mathContext).remainder(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext))
        is BigDecimal -> this.remainder(that.toBigDecimal(DefaultBigDecimalPrecision.mathContext))
        else -> throw UnsupportedOperationException()
    }
}
