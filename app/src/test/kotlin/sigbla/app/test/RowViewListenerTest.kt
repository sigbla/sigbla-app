...
class RowViewListenerTest {
    ...
    fun `subscribe and unsubscribe cellview`() {
        ...
        tv1["B", 1][CellHeight] = 125
        tv1["B", 1][CellWidth] = 125
        tv1["B", 1][CellClasses] = "cell-classes-4"
        tv1["B", 1][CellTopics] = "cell-topics-4"
        ...
        tv1["C", 1][CellHeight] = 175
        tv1["C", 1][CellWidth] = 175
        tv1["C", 1][CellClasses] = "cell-classes-6"
        tv1["C", 1][CellTopics] = "cell-topics-6"
        tv1["C", 1][CellTransformer] = {}
    ...
    fun `subscribe to filled table and unsubscribe cellview`() {
        ...
        tv1["C", 1][CellHeight] = 150
        tv1["C", 1][CellWidth] = 150
        tv1["C", 1][CellClasses] = "cell-classes-6"
        tv1["C", 1][CellTopics] = "cell-topics-6"
        tv1["C", 1][CellTransformer] = {}
    ...
    fun `listener loop support`() {
        ...
        val ref1 = on(t[0], skipHistory = true) {
            events {
                t["A", 0][CellWidth] = 25
            }
        }
    ...
    fun `old and new table is a clone of source table`() {
        ...
        on(t[0]) {
            events {
                oldView["A", 0][CellWidth] = source["A"].derived.cellWidth + 200
                newView["A", 0][CellWidth] = source["A"].derived.cellWidth + 300

                assertEquals(source["A"].derived.cellWidth + 200, oldView["A", 0][CellWidth].width)
                assertEquals(source["A"].derived.cellWidth + 300, newView["A", 0][CellWidth].width)
    ...
    fun `type filtering for subscriptions`() {
        ...
        on<CellWidth<*, *>>(tv1[1]) events {
            eventCount2 += count()
        }

        on<CellClasses<*>>(tv1[1]) events {
            eventCount3 += count()
        }

        on<CellTopics<*>>(tv1[1]) events {
            eventCount4 += count()
        }

        on<Resources>(tv1[1]) events {
            eventCount5 += count()
        }

        on<SourceTable>(tv1[1]) events {
            eventCount6 += count()
        }
    ...
    fun `type filtering for chained subscriptions`() {
        ...
        on<CellWidth<*,*>>(tv1[1], name = "Listener 2") events {
            eventCount2 += count()
            forEach {
