...
class CellRangeListenerTest {
    ...
    fun `type filtering for subscriptions`() {
        ...
        on<Any, String>(t1["A", 0]..t1["A", 1]) events {
            eventCount1 += count()
        }

        on<Any, Long>(t1["A", 0]..t1["A", 1]) events {
            eventCount2 += count()
        }

        on<String, Any>(t1["A", 0]..t1["A", 1]) events {
            eventCount3 += count()
        }

        on<Long, Any>(t1["A", 0]..t1["A", 1]) events {
            eventCount4 += count()
        }

        on<String, Long>(t1["A", 0]..t1["A", 1]) events {
            eventCount5 += count()
        }

        on<Long, String>(t1["A", 0]..t1["A", 1]) events {
            eventCount6 += count()
        }
    ...
    fun `type filtering for chained subscriptions`() {
        ...
        on<Any, String>(t1["A", 1]..t1["A", 2], name = "Listener 1") events {
            eventCount1 += count()
            forEach {
        ...
        on<Long, Long>(t1["A", 1]..t1["A", 2], name = "Listener 2") events {
            eventCount2 += count()
            forEach {
    ...
    fun `type filtering for chained subscriptions without type filter`() {
        ...
        on(t1["A", 1]..t1["A", 2], name = "Listener 1") events {
            eventCount1 += count()
            forEach {
        ...
        on(t1["A", 1]..t1["A", 2], name = "Listener 2") events {
            eventCount2 += count()
            forEach {
