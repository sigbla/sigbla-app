        ...
        batch(t) {
            on(t) {
                events {
                    ...
                    assertEquals<Any>(source["A", 0] + 200, (oldTable["A", 0].asLong ?: throw InvalidCellException("")))
                    assertEquals<Any>(source["A", 0] + 300, (newTable["A", 0].asLong ?: throw InvalidCellException("")))
