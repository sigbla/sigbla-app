...
class RowViewBatchListenerTest {
    @Test
    ...
    fun `subscribe to filled table and unsubscribe cellview`() {
        ...
        batch(tv1) {
            ...
            tv1["A", 4][CellHeight] = 150
            tv1["A", 4][CellWidth] = 150
            tv1["A", 4][CellClasses] = "cell-classes-6"
            tv1["A", 4][CellTopics] = "cell-topics-6"
            tv1["A", 4][CellTransformer] = {}
